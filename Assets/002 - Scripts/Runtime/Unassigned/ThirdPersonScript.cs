...
public class ThirdPersonScript : MonoBehaviour
{
    ...
    private void Update()
    {
        GetComponent<Animator>().SetFloat("Vertical", player.movement.correctedZInput, 1f, Time.deltaTime * 10f);
        GetComponent<Animator>().SetFloat("Horizontal", player.movement.correctedXInput, 1f, Time.deltaTime * 10f);
    }
