...
public class ThirdPersonScript : MonoBehaviour
{
    ...
    private void Update()
    {
        GetComponent<Animator>().SetFloat("Vertical", player.GetComponent<Movement>().correctedXInput, 1f, Time.deltaTime * 10f);
        GetComponent<Animator>().SetFloat("Horizontal", player.GetComponent<Movement>().correctedZInput, 1f, Time.deltaTime * 10f);
    }
