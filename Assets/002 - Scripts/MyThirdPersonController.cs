...
public class MyThirdPersonController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        notMyFPSController = GameObject.FindGameObjectWithTag("Player").GetComponent<FPSControllerLPFP.FpsControllerLPFP>();
    }
    ...
    private void Update()
    {
        ...
        //Run forward
        if (Input.GetKey(KeyCode.W) && notMyFPSController._isGrounded)
        {
            Debug.Log("Forward");
            ...
            if (Input.GetKey(KeyCode.D) && notMyFPSController._isGrounded)
            {
        ...
        else if (Input.GetKey(KeyCode.D) && notMyFPSController._isGrounded)
        {
            anim.SetFloat("Vertical", 0.0f, 0, Time.deltaTime);
            anim.SetFloat("Horizontal", 1.0f, 0, Time.deltaTime);
        }
        else if (Input.GetKey(KeyCode.S) && notMyFPSController._isGrounded)
        {
            anim.SetFloat("Vertical", -1.0f, 0, Time.deltaTime);
            anim.SetFloat("Horizontal", 0.0f, 0, Time.deltaTime);
        }
        else if (Input.GetKey(KeyCode.A) && notMyFPSController._isGrounded)
        {
            anim.SetFloat("Vertical", 0.0f, 0, Time.deltaTime);
            anim.SetFloat("Horizontal", -1.0f, 0, Time.deltaTime);
        }
        else if (Input.GetKey(KeyCode.W) && Input.GetKey(KeyCode.D) && notMyFPSController._isGrounded)
        {
            Debug.Log("Diagonal 1");
            anim.SetFloat("Vertical", 1.0f, 0, Time.deltaTime);
            anim.SetFloat("Horizontal", 1.0f, 0, Time.deltaTime);
