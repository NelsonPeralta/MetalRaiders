...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Resources/CubeInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CubeInput: IInputActionCollection2, IDisposable
{
    ...
    ~@CubeInput()
    {
        UnityEngine.Debug.Assert(!m_Cube.enabled, "This will cause a leak and performance issues, CubeInput.Cube.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "Cube".
    /// </summary>
    public struct CubeActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Cube/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_Cube_Move;
        /// <summary>
        /// Provides access to the underlying input action "Cube/MoveUp".
        /// </summary>
        public InputAction @MoveUp => m_Wrapper.m_Cube_MoveUp;
        /// <summary>
        /// Provides access to the underlying input action "Cube/MoveDown".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="CubeActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="CubeActions.UnregisterCallbacks(ICubeActions)" />.
        /// </summary>
        /// <seealso cref="CubeActions.UnregisterCallbacks(ICubeActions)" />
        ...
        /// </remarks>
        /// <seealso cref="CubeActions.AddCallbacks(ICubeActions)" />
        /// <seealso cref="CubeActions.RemoveCallbacks(ICubeActions)" />
        /// <seealso cref="CubeActions.UnregisterCallbacks(ICubeActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="CubeActions" /> instance referencing this action map.
    /// </summary>
    public CubeActions @Cube => new CubeActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Cube" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="CubeActions.AddCallbacks(ICubeActions)" />
    /// <seealso cref="CubeActions.RemoveCallbacks(ICubeActions)" />
